...
function Main(_ref) {
  ...
  return wp.element.createElement("div", {
    ...
    return wp.element.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_4__.Link, {
      key: item.name,
      to: item.href,
      className: "".concat(isActive(item.href) ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white", " rounded-md px-3 py-2 text-sm font-medium focus:")
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("be2e3a57c122e549d8dc")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.21fa60d86054af81f091.hot-update.js.map