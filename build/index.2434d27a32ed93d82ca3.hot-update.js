...
function Main(_ref) {
  ...
  return wp.element.createElement("div", {
    ...
    return wp.element.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_4__.Link, {
      key: item.name,
      to: item.href,
      className: "flex-grow text-slate-500 hover:text-primary border-b-2 hover:border-primary focus:border-primary py-6 px-4 sm:p-6 hover:bg-gray-liter max-w-[9rem] focus:outline-none focus:shadow-none ".concat(isActive("/") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white", " rounded-md px-3 py-2 text-sm font-medium")
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("11dd84e20918edc7897f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.2434d27a32ed93d82ca3.hot-update.js.map