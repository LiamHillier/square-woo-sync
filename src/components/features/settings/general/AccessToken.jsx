  ...
  return (
    <div className="px-4 py-5 sm:p-6">
      ...
      <div className="mt-2 max-w-xl text-sm text-gray-500">
        <p>
          Read the following documentation on how to create a square access
          token: <br></br>
        ...
        <>
          <div className="mt-5 sm:flex sm:items-center">
            <input
              ...
              name="existingToken"
              id="existingToken"
              className="block !rounded-lg !border-0 !py-1.5 text-gray-900 !ring-1 !ring-inset !ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm !px-4 !leading-6"
              value={existingToken}
              disabled
            />
            <button
          ...
          <p className="mt-2">
            Removing your access token will stop all synchronization with Square
          </p>
        </>
      ) : (
