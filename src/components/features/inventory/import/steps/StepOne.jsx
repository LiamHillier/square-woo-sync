    ...
    <div>
      ...
      <fieldset className="mb-3">
        ...
        <div className="flex gap-x-6 gap-y-4 items-start flex-wrap">
          ...
          <label htmlFor="SKU" className="flex items-center gap-1 leading-none">
            <input
              type="checkbox"
              required
      ...
      <p>
        Existing products will have their data updated, while new entries will
        be created for products not already in the system.
      </p>
      <h4 className="text-base mt-4 mb-2">
        How many products to import in each batch?
      </h4>
      <p>
        Increasing the number in each batch places a greater load on the server
        (especially when import images). If you encounter errors, consider
        reducing this value for better stability or disabling image import.
      </p>
