...
class Manager {
    ...
    public function get_scripts(): array {
        $dependency = require_once SWS_DIR . '/build/index.asset.php';

        return [
            'sws-app' => [
                'src'       => SWS_BUILD . '/index.js',
    ...
    public function enqueue_admin_assets() {
        ...
        if ( ! is_admin() || ! isset( $_GET['page'] ) || sanitize_text_field( wp_unslash( $_GET['page'] ) ) !== 'square-woo-sync' ) {
            return;
        }
